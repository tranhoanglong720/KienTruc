...
public class FileNotFoundException  extends org.apache.axis.AxisFault  implements java.io.Serializable {
    ...
    /**
     * Gets the message1 value for this FileNotFoundException.
     * 
     * @return message1
     */
    ...
    /**
     * Sets the message1 value for this FileNotFoundException.
     * 
     * @param message1
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("tranhoanglong", "FileNotFoundException"));
